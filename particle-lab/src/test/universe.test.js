...
describe('Universe Simulation', () => {
  ...
  it('should fuse two Hydrogens into Helium on collision', () => {
    const p1 = { x: 100, y: 100, vx: 10, vy: 0, type: PARTICLE_TYPES.HYDROGEN };
    const p2 = { x: 102, y: 100, vx: -10, vy: 0, type: PARTICLE_TYPES.HYDROGEN }; // Close enough (< 100 distSq)
  ...
  it('should fuse two Heliums into Carbon on collision', () => {
    const p1 = { x: 100, y: 100, vx: 0, vy: 0, type: PARTICLE_TYPES.HELIUM };
    const p2 = { x: 100, y: 105, vx: 0, vy: 0, type: PARTICLE_TYPES.HELIUM };
    const particles = [p1, p2];
    const onDiscover = vi.fn();
