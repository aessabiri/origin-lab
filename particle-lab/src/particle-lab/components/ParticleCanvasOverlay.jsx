...
const ParticleCanvasOverlay = ({
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      {/* 4. Bottom-Left Context Menus - REMOVED */}
      ...
      <div className="absolute bottom-4 right-4 flex flex-col gap-3 z-30 pointer-events-auto">
        <button
          ...
          className="w-12 h-12 bg-red-600 hover:bg-red-500 text-white rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110 border-2 border-red-400"
          title="Empty Canvas"
