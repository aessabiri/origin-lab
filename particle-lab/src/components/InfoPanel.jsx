...
import { PARTICLE_INFO, PARTICLE_NAMES } from '../constants/particles.js';
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-gray-800 text-white p-8 rounded-lg shadow-2xl max-w-lg w-full border border-gray-700" onClick={e => e.stopPropagation()}>
        ...
        <button onClick={onClose} className="mt-8 w-full px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 font-bold transition-colors">Close</button>
      </div>
    </div>
  );
};
