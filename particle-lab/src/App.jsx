...
const App = () => {
  const {
    ...
    isHintVisible, setIsHintVisible,
    infoPanelType, setInfoPanelType,
  ...
  const [visualEffects, setVisualEffects] = React.useState([]);
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 z-10">
          ...
          <ActionMenu
            ...
            onOpenTimeline={() => openExclusive('isTimelineVisible', 'isTimelineVisible')}
            onOpenStellarNursery={() => openExclusive('isStellarNurseryVisible', 'isStellarNurseryVisible')}
